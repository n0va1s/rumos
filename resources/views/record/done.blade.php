<x-guest-layout>
    ...
    <div class="bg-white py-4">
        <div class="mx-auto max-w-md inline-block px-6">
            ...
            <div class="flex items-center justify-center h-screen">
                <img class="max-w-full h-auto rounded-full" src="{{ asset('img/done.svg') }}">
            </div>
            <div class="inline-flex justify-center items-center sm:flex-none">
                <div class="inline-flex justify-center items-center sm:flex-none">
                    <!-- Heroicon name: phone -->
                ...
                <div class="inline-flex justify-center items-center sm:flex-none">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-6 w-8 h-8">
