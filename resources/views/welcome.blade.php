    ...
    <div class="bg-white">
        <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
            <div>
                ...
                <p class="mt-4 text-gray-500">Você está na área restrita do portal emaus.org.br</p>
                @if (Route::has('login'))
                <!--<div class="fixed top-0 right-0 px-6 py-4">-->
                <div class="mt-8 flex gap-x-4">
                    @auth
                    <a href="{{ url('/dashboard') }}" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Início</a>
                    @else
