            ...
            <form method="POST" action="{{ route('rumos.search') }}">
                ...
                <div class="bg-white p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <x-select class="col-span-6 sm:col-span-3" label="Secretariado" :options="$communities" :selected="Auth::user()->community_id" :disabled="false">
                        </x-select>
                    </div>
                </div>
                            ...
                            <table class="min-w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                            <button type="submit" title="Equipe de orientação" class="inline-flex rounded-md border border-transparent bg-white py-2 px-4 text-sm font-medium text-blue-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-50 focus:ring-offset-2">
                                            ...
                                            <button type="submit" title="Equipe de apoio ou serviço" class="inline-flex rounded-md border border-transparent bg-white py-2 px-4 text-sm font-medium text-blue-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-50 focus:ring-offset-2">
                                            ...
                                            <button type="submit" title="Cursista" class="inline-flex rounded-md border border-transparent bg-white py-2 px-4 text-sm font-medium text-blue-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-50 focus:ring-offset-2">
                                            ...
                                            <button type="submit" title="Foto oficial" class="inline-flex rounded-md border border-transparent bg-white py-2 px-4 text-sm font-medium text-blue-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-50 focus:ring-offset-2">
