    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <div class="mt-6 bg-white shadow-sm rounded-lg divide-y">
            <div class="grid grid-cols-2">
                <div class="p-10">
                    <h3 class="text-2xl px-6 py-6">Cadastro da Equipe da Cozinha</h3>
                    <p class="px-6 mt-1 text-sm text-gray-600">Se não encontrar alguém na lista, use o botão Cadastrar</p>
                </div>
            ...
            <form method="POST" action="{{ route('rumos.kitchen.store') }}">
                @csrf
                @include('rumo.includes._formTeam');
            </form>
        </div>
    </div>
</x-app-layout>