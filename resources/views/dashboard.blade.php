                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="bg-white">
                        <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                            <h2 class="sr-only">Administração do Curso de Emaús</h2>
                            <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                                <a href="#" class="group">
                                    <div class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-w-7 xl:aspect-h-8">
                                        <img src="https://tailwindui.com/img/ecommerce-images/category-page-04-image-card-01.jpg" alt="Tall slender porcelain bottle with natural clay textured body and cork stopper." class="h-full w-full object-cover object-center group-hover:opacity-75">
                                    </div>
                                    <h3 class="mt-4 text-lg text-gray-700">Dirigentes</h3>
                                    <p class="mt-1 text-sm font-medium text-gray-900">Cadastro de timoneiro, Diretor Espiritual, monitores e etc</p>
                                </a>
                                ...
                                <a href="#" class="group">
                                    ...
                                    <h3 class="mt-4 text-lg text-gray-700">Equipes</h3>
                                    <p class="mt-1 text-sm font-medium text-gray-900">Cadastro das equipes de orientação e serviço</p>
                                </a>
                                ...
                                <a href="#" class="group">
                                    ...
                                    <h3 class="mt-4 text-lg text-gray-700">Cursistas</h3>
                                    <p class="mt-1 text-sm font-medium text-gray-900">Vinculação de fichas aprovadas aos monitores de um curso</p>
                                </a>
                                ...
                                <a href="#" class="group">
                                    ...
                                    <h3 class="mt-4 text-lg text-gray-700">Foto</h3>
                                    <p class="mt-1 text-sm font-medium text-gray-900">Cadastro da foto oficial</p>
                                </a>
                            </div>
                        </div>
                        <div class="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                            ...
                            <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                                <a href="#" class="group">
                                    ...
                                    <h3 class="mt-4 text-lg text-gray-700">Inscrições</h3>
